...
`home_assistant_telemetry` de publier la capacité métier
`home_assistant.telemetry.freshness`. L’identifiant `shelly_telemetry` reste un
alias de migration pour les configurations antérieures à Agent 1.9.0.
