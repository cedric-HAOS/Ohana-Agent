...
from ohana_agent.infrastructure.enums import ServiceType
from ohana_agent.infrastructure.infrastructure_health_update import (
    InfrastructureHealthUpdate,
)
from ohana_agent.infrastructure.runtime import InfrastructureRuntime
    ...
    def map(
        ...
        *,
        ...
        return self._factory.create(
            ...
            status=status,
            success=status in {ObservationStatus.HEALTHY, ObservationStatus.SUSPENDED},
