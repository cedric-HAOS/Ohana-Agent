"""Small REST client used by Home Assistant telemetry checks."""
...
class HomeAssistantTelemetryClient:
    ...
    def query_entity(
        ...
        *,
        ...
        """Return current value and latest report timestamp for one entity."""
        ...
        request = Request(
            ...
            headers={
                ...
                "User-Agent": "Ohana-Agent Home Assistant telemetry check",
            },
        )
        context = None
